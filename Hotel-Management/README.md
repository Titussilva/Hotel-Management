...
Use a Gmail app password for `GMAIL_APP_PASSWORD`. If Gmail is not configured, the app still saves the booking and prints the email content in the server logs for local testing.
